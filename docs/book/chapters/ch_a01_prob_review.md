...
**Nguồn web:** [https://learningds.org/ch/a01/prob_review.html](https://learningds.org/ch/a01/prob_review.html)  
**Nguồn tải:** `web-html` | `ch/a01/prob_review`
...
-
The probability of an event is a real number between 0 and 1, inclusive: \(0 \leq P(\text{event}) \leq 1\).
-
The probability of the entire outcome space is 1: \(P(\Omega) = 1\).
...
In the 2010 census, 1.4% of US citizens were 17 years old and 1.5% were 18. Thus, for a randomly chosen US citizen in 2010, \(P(A) = 0.014\) and \(P(B) = 0.015\), giving \( P(A \cup B) = P(A) + P(B) = 0.029 \).
